...
export const INITIAL_SYSTEM_SETTINGS: SystemSettings = {
  ...
  adminRocketNumber: '01900000000-1',
  adminUpayNumber: '01600000000',
  adminPaymentAccountType: 'merchant',
  adminPaymentInstructions: 'প্ল্যাটফর্মের অফিসিয়াল নম্বরে পেমেন্ট করুন এবং ট্রানজেকশন আইডি প্রদান করুন।',
...
export const INITIAL_SELLERS: SellerStore[] = [
  {
    ...
    rocketNumber: '01911223344-2',
    upayNumber: '01611223344',
    paymentAccountType: 'merchant',
